...
class AdManager(private val context: Context, private val activity: Activity,val adManagerListener: AdManagerListener) {
    ...
    private fun checkAdValue(adLocation: String?,adKey:String?,provider: String) {
        ...
        if (adLocation.equals(Constants.adMiddle,true)||adLocation.equals(Constants.adBefore,true)
            ...
            if (provider.equals(Constants.chartBoost,true))
            {
                ...
                {
                    val yourArray: List<String> = interstitialAdValue.split(Constants.mySecretCheckDel)
    ...
    fun loadAdProvider(provider:String,adLocation: String,adView: LinearLayout?,linearLayout: LinearLayout?,relativeLayout: RelativeLayout?,
     startAppBanner:Banner?)
    {
        ...
        {
            facebookSdkInitialization(adLocation,adView,linearLayout,relativeLayout,startAppBanner)
        }
        else if (provider.equals(Constants.unity,true))
        {
        ...
        {
            chartboostSdkInitialization(adLocation,adView,linearLayout,relativeLayout,startAppBanner)
        }
        else if (provider.equals(Constants.startApp,true))
        {
            startAppSdkInitialization(adLocation,adView,linearLayout,relativeLayout,startAppBanner)
        }
    }
    ...
    private fun unitySdkInitialization(
        ...
        {
            loadAdAtParticularLocation(adLocation,
                Constants.unity,adView,linearLayout,relativeLayout,banner)
        }
        else
        {
            UnityAds.initialize(context, Constants.unityGameID, Constants.unityTestMode, object :IUnityAdsInitializationListener{
    ...
    private fun showBanner(s: RelativeLayout?) {

        s?.removeAllViews()
        s?.addView(bottomBanner)
    ...
    private fun adMobSdkInitializationOrAdmobAd(
        ...
        {
            loadAdAtParticularLocation(locationName,
...
//                showStartAppAd()
    ...
    private fun loadAdAtParticularLocation(locationName: String, adProviderName: String,adView: LinearLayout?,linearLayout: LinearLayout?
    ,relativeLayout: RelativeLayout?,banner: Banner?) {
    ...
    private fun inflateFbNativeAd(
     ...
     fun loadAdmobNativeAd(view_holder: ViewHolder,nativeAdView: NativeAdView) {
        ...
        val adLoader = builder.withAdListener(object : AdListener() {
            ...
            override fun onAdLoaded() {
                adView = view_holder.itemView.findViewById(R.id.nativeAdView)
