...
class VerticalSlider : View {
    ...
    private var iconHigh: Bitmap? = null
    private var iconMedium: Bitmap? = null
    private var iconLow: Bitmap? = null

    private var cornerRadius = dpToPx(5).toFloat()
        set(value) {
            field = value
            invalidate()
        }
    ...
    private var onProgressChangeListener: OnSliderProgressChangeListener? = null
